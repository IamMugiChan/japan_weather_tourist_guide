...
<html lang="en">
                            ...
                            <div class="card mb-3" >
                                <div class="card-body" >
                                    <div class="d-flex fw-bold small mb-3">
                                        <span class="flex-grow-1"><a href="/"><i class="fa fa-arrow-left"></i></a> Places to visit in Sapporo Japan</span>
                                        <a href="#" data-toggle="card-expand" class="text-white text-opacity-50 text-decoration-none"><i class="bi bi-fullscreen"></i></a>
                                    </div>

                                    <div class="ratio ratio-21x9 mb-3" style="height: 500px;">
                                        <iframe src="https://www.google.com/maps/d/embed?mid=1oN2QqnOlLrt5Vr2BGD5P9dTZj7U&hl=en_US&ehbc=2E312F" width="640" height="480"></iframe>
                                    </div>
                                </div>
    ...
    <script type="text/javascript" src="{{ URL::asset('js/sapporo.js') }}"></script>
</html>
